...
\item \textbf{Read Chapter~\ref{ch:measurement_theory}} (Fundamentals of Measurement Theory). Focus on the five-block system and sensor terminology.
...
\item \textbf{Read Chapter~\ref{ch:labview}} (LabVIEW). Familiarize yourself with DAQmx, essential VIs, and the ``Common Mistakes'' checklist.
