...
\textbf{Output current limits}: the digital outputs can provide approximately 3--5\,mA per pin. Do not drive LEDs, relays, or motors directly from the digital outputs; use a transistor or MOSFET driver (Chapter~\ref{ch:highpower}).
