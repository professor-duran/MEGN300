...
\end{tikzpicture}
\caption{The three modes of heat transfer (Figure~\ref{fig:heat_modes}) with governing equations and typical coefficient ranges. Convection coefficient $h$ varies by three orders of magnitude, making it the dominant design variable for sensor thermal time constants.}
