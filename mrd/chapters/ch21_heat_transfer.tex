...
\begin{tikzpicture}[
    ...
    cap/.style={font=\scriptsize\sffamily, AccentTeal},
]
% Thermal circuit
...
\node[cap, above=3pt] at (4,2) {$T_{\text{surface}}$};
...
\node[cap, above=3pt] at (7,2) {$T_{\text{sensor}}$};
