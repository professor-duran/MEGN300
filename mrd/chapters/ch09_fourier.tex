...
Every real signal is a superposition of sinusoids. If your measurement system attenuates or phase-shifts any frequency component differently from others, the reconstructed signal is distorted. Understanding Fourier decomposition lets you predict how your sensor's frequency response (Chapter~3) and your filters (Chapters~\ref{ch:analog_filters}--\ref{ch:digital_filters}) will affect the measured signal.
\end{tipbox}
