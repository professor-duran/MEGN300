...
\label{ch:highpower}\index{MOSFET}\index{relay}\index{SSR}\index{flyback diode\index{flyback diode} (Figure~\ref{fig:mosfet_flyback})}\index{PWM\index{PWM (pulse width modulation)}}\index{H-bridge}
