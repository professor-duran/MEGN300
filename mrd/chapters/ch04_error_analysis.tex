...
\end{tikzpicture}
\caption{RSS error budget\index{error budget} for a temperature measurement system. The sensor dominates; improving the ADC has diminishing returns. Always improve the dominant contributor first.}
