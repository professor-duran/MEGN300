...
A temperature difference between two junctions of dissimilar metals generates a voltage (Seebeck effect). Type~K (chromel-alumel): 41\,$\mu$V/\degC{}, range $-200$ to $+1260$\,\degC{}. Type~T (copper-constantan): 43\,$\mu$V/\degC{}, range $-200$ to $+400$\,\degC{}. Requires a \textbf{reference junction} at a known temperature (ice point or electronic cold-junction compensation).
