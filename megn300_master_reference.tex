...
Selecting a sensor or actuator & Need transduction principles & Ch.~6 (Sensors \& Actuators) \\
Choosing ADC settings & Bits, sample rate, range & Ch.~7 (Analog vs.\ Digital) \\
Seeing noisy data & Need to improve SNR & Ch.~8 (SNR) + Ch.~12 (Filters) \\
Running an FFT in LabVIEW & Need parameters and windows & Ch.~10 (FFT) \\
Getting aliased data & False frequencies appearing & Ch.~11 (DSP Fundamentals) \\
Designing an anti-alias filter & Need cutoff and order & Ch.~12 (Analog Filters) \\
Need circuit fundamentals & Ohm's Law, KVL/KCL, dividers & Ch.~14 (Circuit Fundamentals) \\
Signal too small for the ADC & Need amplification & Ch.~15 (Amplifiers) \\
Driving a motor or heater & Need switching circuits & Ch.~16 (High-Power Devices) \\
System not working after assembly & Need debugging methodology & Ch.~17 (Debugging) \\
Control loop oscillating & PID gain too high & Ch.~20 (PID), Sec.~20.3 \\
PID has steady-state offset & Missing integral action & Ch.~20 (PID), Sec.~20.2 \\
PID overshoots massively & Integral windup & Ch.~20 (PID), Sec.~20.4 \\
Working with fluid systems & Flow, pressure, hydraulics & Ch.~22 (Fluid Power) \\
