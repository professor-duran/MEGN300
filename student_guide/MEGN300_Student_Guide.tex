...
\begin{protip}
\textbf{The INA128 is your best friend for bridge circuits.} It has $>$10\,G$\Omega$ balanced input impedance, $>$100\,dB CMRR, and gain set by a single resistor with $G = 1 + 50\,\text{k}\Omega/R_G$. For $G=100$: $R_G = 50\,\text{k}\Omega/99 = 505\,\Omega$ (use 510\,$\Omega$ standard). Whenever you measure a Wheatstone bridge (strain gauge, RTD, load cell), reach for an instrumentation amplifier first.
\end{protip}
