...
Calculate the LSB: $\text{LSB} = V_{\text{range}} / 2^n$. Compare this to your sensor's output change per unit measurand. If your thermocouple produces 40\,$\mu$V/\textdegree{}C and your ADC LSB is 2.44\,mV (12-bit, 10\,V range), your temperature resolution is $2.44\,\text{mV} / 0.040\,\text{mV/\textdegree{}C} = 61$\,\textdegree{}C. That is useless. You need amplification (Chapter~15 of the MRD) to bring the signal into the ADC's usable range.
\end{faqbox}
